...
//
// # go test -benchmem -run=none geth-timing/swarm/storage/localstore -bench BenchmarkRetrievalIndexes -v
// goos: darwin
// goarch: amd64
// pkg: geth-timing/swarm/storage/localstore
...
//
// go test -benchmem -run=none geth-timing/swarm/storage/localstore -bench BenchmarkUpload -v
// goos: darwin
// goarch: amd64
// pkg: geth-timing/swarm/storage/localstore
